...
My first model: benchmark_lr_model.ipynb uses ridge regression to predict exact finishing order, serving as my benchmark for my in-progress, more complex models. To run, it requires the 4 race data csv files and the Racing Insights weekly finishing order prediction csv, to be used for comparison with my model. 
