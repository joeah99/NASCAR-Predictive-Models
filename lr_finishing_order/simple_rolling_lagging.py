...
def lagging_rolling_generator(df, features, sort_list, filter_list, window, suffix):
    new_cols = {}
    ...
    for feature in features:
        ...
        new_cols[f"{feature}_roll{window}_{suffix}"] = (
...
def reconcile_driver_carteams(df, features, window, suffix):
    
    for feature in features:
        # fill lagging features
        ...
        driver_roll_col = f"{feature}_roll{window}_{suffix}"
